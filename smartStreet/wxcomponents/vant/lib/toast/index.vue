<template>
<uni-shadow-root class="vant-lib-toast-index"><van-overlay v-if="mask || forbidClick" :show="show" :mask="mask" :z-index="zIndex"></van-overlay>
...
global['__wxRoute'] = 'vant/lib/toast/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/toast/index']
</script>
