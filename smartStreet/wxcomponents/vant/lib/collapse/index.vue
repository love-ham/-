<template>
<uni-shadow-root class="vant-lib-collapse-index"><view :class="'custom-class van-collapse '+(border ? 'van-hairline--top-bottom' : '')">
  <slot></slot>
...
global['__wxRoute'] = 'vant/lib/collapse/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/collapse/index']
</script>
