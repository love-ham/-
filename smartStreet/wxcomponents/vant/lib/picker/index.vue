<template>
<uni-shadow-root class="vant-lib-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = 'vant/lib/picker/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/picker/index']
</script>
