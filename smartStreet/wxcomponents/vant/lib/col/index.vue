<template>
<uni-shadow-root class="vant-lib-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="style">
  <slot></slot>
...
global['__wxRoute'] = 'vant/lib/col/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/col/index']
</script>
