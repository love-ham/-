<template>
<uni-shadow-root class="vant-lib-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = 'vant/lib/panel/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/panel/index']
</script>
