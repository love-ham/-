<template>
<uni-shadow-root class="vant-lib-rate-index"><view class="van-rate custom-class" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'vant/lib/rate/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/rate/index']
</script>
