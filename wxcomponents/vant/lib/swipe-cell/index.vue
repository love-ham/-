<template>
<uni-shadow-root class="vant-lib-swipe-cell-index"><view class="van-swipe-cell" data-key="cell" @click.stop.prevent="onClick" @touchstart="startDrag" @touchmove.stop.prevent="_$self[(catchMove ? 'noop' : '')||'_$noop']($event)" @touchmove.capture="onDrag" @touchend.stop.prevent="endDrag" @touchcancel.stop.prevent="endDrag">
...
global['__wxRoute'] = 'vant/lib/swipe-cell/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/swipe-cell/index']
</script>
