<template>
<uni-shadow-root class="vant-lib-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = 'vant/lib/search/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/search/index']
</script>
