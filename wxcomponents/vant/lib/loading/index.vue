<template>
<uni-shadow-root class="vant-lib-loading-index"><view class="van-loading custom-class" :style="'width: '+(size)+'; height: '+(size)">
...
global['__wxRoute'] = 'vant/lib/loading/index'
"use strict";
...
export default global['__wxComponents']['vant/lib/loading/index']
</script>
